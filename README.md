...
## 💭 프로젝트 설명
> 여러 쇼핑 플랫폼에서 사고 싶은 물건을 보관할 때 갤러리, 카카오톡 나에게 보내기 등 무분별하게 보관하여 한눈에 파악하기 어려운 점 없으신가요? 
>
>**WishBoard**는 **위시리스트 항목을 한 곳에 모아 보관**할 수 있도록 해줍니다. 
>
>상품 일정(프리오더, 재입고, 할인 등)관리의 불편함을 줄여줌으로써 **사용자에게 상품 구매 편의를 제공**합니다.

`ui 사진이 들어가면 좋을 것 같음!!!! (간단한 UI 화면을 넣어주면 좋을 것 같음! 아니면 우리 발표 ppt에 올린 시연 영상 같은 것도 갱찬을 듯! )`

## 💭 프로젝트 핵심 기능
#### 1. 위시리스트 아이템 등록
- 링크 공유를 통한 간편 등록과 사용자의 수동 등록으로 위시리스트 등록 방식 제공합니다.
#### 2. 폴더 관리
- 위시리스트를 더 쉽게 관리할 수 있도록 폴더 관리 기능 제공합니다.
#### 3. 알림 관리
